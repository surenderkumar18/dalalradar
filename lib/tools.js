    ...
    ? [
        {
          id: "filters",
          name: "Filters",
          tagline: "[DEV] Internal filter tool",
          description:
            "Internal tool for building and testing filter logic. Only visible in development mode.",
          status: "dev",
          href: "/tools/filters",
          icon: "filter",
          accent: "var(--text-mute)",
          features: [
            "Build complex filter pipelines",
            "Test signal combinations",
            "Dev-only — not visible on live site",
          ],
        },
